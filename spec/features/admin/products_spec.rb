...
describe 'Admin - Products', js: true do
  ...
  context 'as Admin' do
    ...
    it 'should display all products' do
      ...
      product2.add_artist! create(:artist)
      product2.reload
      product3 = create :product
      product3.add_artist! create(:artist)
      product3.reload
  ...
  context 'as artist' do
    ...
    before do
      @artist_user = create(:artist_user)
      @artist = @artist_user.artist
      login_user @artist_user
    end

    context "searching products works with only artists in results" do
      it "should be able to search deleted products", :js => true do
        ...
        p1.add_artist! @artist
        p2 = create(:product, :name => 'zomg shirt')
        p2.add_artist! @artist
      ...
      it "should be able to search products by their properties with only artists in results" do
    ...
    context "creating a new product from a prototype" do
      ...
      it "should allow an artist to create a new product and variants from a prototype" do
        ...
        # Check artists assigned properly
        expect(Spree::Product.last.artist_ids).to include(@artist.id)
      end
    ...
    context "creating a new product" do
      ...
      it "should allow an artist to create a new product" do
        visit spree.admin_products_path
        click_link "admin_new_product"
        within('#new_product') do
          page.should have_content("SKU")
    ...
    context "cloning a product" do
      it "should allow an artist to clone a product" do
        p = create(:product)
        p.add_artist! @artist
      ...
      context "cloning a deleted product" do
        it "should allow an artist to clone a deleted product" do
    ...
    context 'updating a product' do
      ...
      it 'should not display artist selection' do
        visit spree.admin_product_path(product)
        page.should_not have_css('#product_artist_id')
      end
    end
